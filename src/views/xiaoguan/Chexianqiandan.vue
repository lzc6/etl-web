	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
		  ...
		  <el-form :inline="true" :model="filters">
              <el-form-item label="车险签单清单：（查询口径：签单日期）">
                </el-form-item>
		...
		<el-table :data="datasall"  v-show="show"     v-loading="listLoading"  style="width: 100%"  height="800" id="table" >
                    ...
                    <el-table-column prop="clauseType" label="条款" width="215" ></el-table-column>
                    <el-table-column prop="LicenseNo" label="车牌" width="215" ></el-table-column>
                    <el-table-column prop="FrameNo" label="车架码" mid-width="215" ></el-table-column>		
...
import moment from "moment"
	...
	export default {
        ...
        //  try {
        //      FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), '车险签单清单.xlsx')
        //  } catch (e) { if (typeof console !== 'undefined') console.log(e, wbout) }
        //  return wbout
            var url = "http://56.145.32.32/etl/data/车险签单清单.xls"
            window.open(url);
       },
			//获取数据
			getdata() {
                ...
                // 56.145.32.54:8081
				// this.$http.post('http://56.145.32.63:8080/xiaoguan/chexianqiandan',para,{ emulateJSON: true }).then((res) => {
                this.$http.post('http://56.145.32.32:8082/xiaoguan/chexianqiandan',para,{ emulateJSON: true }).then((res) => {
