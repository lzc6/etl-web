	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
		  ...
		  <el-form :inline="true" :model="filters">
              <el-form-item label="车商口径清单：（查询口径：起保日期）">
                </el-form-item>
		...
		<el-table :data="dataspage"    v-loading="listLoading"  style="width: 100%"  height="700"  >
            ...
            <el-table-column prop="xuzhuanbao" label="新续转" width="215" ></el-table-column>
            ...
            <el-table-column prop="engineno" label="发动机号" width="215" ></el-table-column>
            <el-table-column prop="enrolldate" label="初登日期" width="215" ></el-table-column>
            <el-table-column prop="carkindcode" label="车型类别" width="215" ></el-table-column>
            ...
            <el-table-column prop="newcarflag" label="新车" width="215" ></el-table-column>
		</el-table>
		...
		<!-- <el-table :data="datasall"  v-show="show"     v-loading="listLoading"  style="width: 100%"  height="800" id="table" >
            ...
            <el-table-column prop="monopolycode" label="推修码" width="215" ></el-table-column>
            <el-table-column prop="monopolyname" label="推修厂" width="215" ></el-table-column>
            <el-table-column prop="newcarflag" label="新车" mid-width="215" ></el-table-column>			
...
import moment from "moment"
    ...
    //      try {
    //          FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), '车商口径清单.xlsx')
    //      } catch (e) { if (typeof console !== 'undefined') console.log(e, wbout) }
    //      return wbout
    //    },
    exportExcel(){
            var url = "http://56.145.32.32/etl/data/车商口径清单.xls"
            window.open(url);
    },
			//获取数据
			getdata() {
                ...
                // 56.145.32.54:8081
				// this.$http.post('http://56.145.32.63:8080/xiaoguan/cheshang',para,{ emulateJSON: true }).then((res) => {
                this.$http.post('http://56.145.32.32:8082/xiaoguan/cheshang',para,{ emulateJSON: true }).then((res) => {
